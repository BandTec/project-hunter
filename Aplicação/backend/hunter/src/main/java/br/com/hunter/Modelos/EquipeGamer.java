...
public class EquipeGamer {
    ...
    private StatusSolicitacao idStatusSolicitacao;
    ...
    public StatusSolicitacao getIdStatusSolicitacao() {
        return idStatusSolicitacao;
    }

    public void setIdStatusSolicitacao(StatusSolicitacao idStatusSolicitacao) {
